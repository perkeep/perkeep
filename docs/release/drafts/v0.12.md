...
Comprehensive summary of all merged work since **v0.11**.
Grouped by **theme** rather than commit author for clarity.
...
### Go Modernization
- Upgraded Go version: 1.15 → 1.16 → 1.19 → 1.21 → **1.24.x**
  _(@bradfitz, @radkat)_
...
- Added **v0.11 release notes** (`@mpl`)
- Made 0.11 version visible on website (`@mpl`)
...
|-----------|------------------|
| **Language & Build** | Migrated to Go 1.24, replaced legacy systems, modernized embedding |
