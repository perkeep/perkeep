...
cam.blobref.isBlobRef = function() {
	let blobRefPattern = null;
	return function(blobRefStr) {
		if (!blobRefPattern) {
			blobRefPattern = new RegExp(cam.blobref.PATTERN);
		}
		return blobRefPattern.test(blobRefStr);
	};
}();
