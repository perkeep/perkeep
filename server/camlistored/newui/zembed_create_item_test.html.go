// THIS FILE IS AUTO-GENERATED FROM create_item_test.html
// DO NOT EDIT.
...
func init() {
	Files.Add("create_item_test.html", 373, fileembed.String("<!doctype html>\n"+
		"<html>\n"+
		"  <head>\n"+
		...
		"  </body>\n"+
		"</html>\n"+
		""), time.Unix(0, 1368718845885413950))
}
