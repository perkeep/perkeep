...
cam.BlobPage.prototype.enterDocument = function() {
	...
	blobdescribe.innerHTML = "<a href='" + goog.uri.utils.appendPath(this.config_.searchRoot, 'camli/search/describe?blobref=' + blobref) + "'>describe</a>";
...
cam.BlobPage.prototype.handleDescribeBlob_ = function(bmap) {
			...
			goog.bind(function(data) {
				...
				if (binfo.camliType == "file") {
					...
					if (!!binfo.file.mimeType &&
						...
						var thumbURL = "<img src='./thumbnail/" + blobref + "/" + fileName + "?mw=" + this.thumbnailSize_ + "&mh=" + this.thumbnailSize_ + "&tv=" + (conf.thumbVersion || '') + "'>";
	...
	bd.innerHTML = "<a href='" + goog.uri.utils.appendPath(this.config_.blobRoot, "camli/" + blobref) + "'>download</a>";
