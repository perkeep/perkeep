...
my $n_blobs = 0;
while (1) {
    print "Enumerating starting at: $after ... ($n_blobs blobs so far)\n";
    my $res = $ua->get("$scheme://$hostport/camli/enumerate-blobs?after=$after&limit=5000");
